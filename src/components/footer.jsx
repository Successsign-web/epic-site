...
const vendorCities = [
  "Kolkata","Hyderabad","Bangalore","Delhi NCR","Mumbai","Jaipur","Patna","Nagpur",
    ...
    <footer className="border-t border-gray-300 relative text-gray-800 pt-20 ">
        ...
        <div className="max-w-7xl mx-auto bg-white rounded-4xl py-6 px-10 absolute top-[-90px] left-[4%] right-[4%]">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            ...
            <div className="flex justify-center md:justify-end">
              <a
                href="tel:+919971120292"
                className="flex items-center gap-3 bg-gradient-to-r from-red-600 to-yellow-600 text-white px-8 py-3 rounded-full text-md font-semibold transition"
              >
      ...
      <div className="max-w-7xl mx-auto px-6 py-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          {/* Get In Touch */}
          <div className="bg-gray-50 rounded-3xl py-3">
            ...
            <div className="space-y-5 text-center sm:text-left flex gap-7">
              <div>
                <div className="flex items-center justify-center sm:justify-start gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:support@epicweddingportal.com" className="text-sm font-medium text-red-600">
                      support@epicweddingportal.com
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-center sm:justify-start gap-3">
                  ...
                  <div>
                    <p className="text-xs text-gray-600">Call / WhatsApp</p>
                    <a href="tel:+919971120292" className="text-sm font-medium text-red-600">
                      +91 99711 20292
                    </a>
                  </div>
                </div>
              ...
              <div className="flex items-start justify-center sm:justify-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium text-gray-800 max-w-xs">
                ...
                <ul className="space-y-3">
                  {cities.map((city) => (
                    <li key={`${cat.slug}-${city}`}>
                      <a
                        href={`https://www.epicweddingportal.com/vendors/${getCitySlug(city)}/${cat.slug}`}
                        target="_blank"
            ...
            <div>
              ...
              <div className="columns-2">
                {vendorCities.map((city) => (
                  <a
                    key={city}
                    href={`https://www.epicweddingportal.com/vendors/${getCitySlug(city)}`}
                    target="_blank"
                    rel="noopener noreferrer"
        ...
        <div className="max-w-7xl mx-auto px-6 text-center text-xs text-gray-600">
          <div className="flex flex-col md:flex-row justify-center items-center gap-2 md:gap-6">
            <div className="flex items-center gap-2">
              ...
              <a href="mailto:support@epicweddingportal.com">support@epicweddingportal.com</a>
              <Phone className="w-4 h-4 text-red-600" />
              <a href="tel:+919971120292">+91 99711 20292</a>
            </div>
            <div className="hidden md:block">•</div>
            <div>
              <MapPin className="w-4 h-4 inline text-red-600" /> 
              3rd Floor, Plot No. 12, Sector 44, Gurugram, Haryana - 122003
            </div>
          </div>

          <p className="mt-4">
            © 2025 EpicWeddingPortal.com | All Rights Reserved by Baraati Media & Entertainment Pvt Ltd 
