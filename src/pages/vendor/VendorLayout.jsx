...
const menuItems = [
    ...
    { icon: Package, label: 'My Packages', link: '/vendor/packages' },
            ...
            <div className="flex items-center gap-5">
              ...
              <div className="flex items-center gap-3 bg-gradient-to-r from-emerald-500 to-teal-600 text-white px-3 py-2 rounded-2xl shadow-lg">
                ...
                <div>
                  ...
                  <p className="text-md font-bold">₹{user.wallet.toLocaleString('en-IN')}</p>
                </div>
              </div>
              ...
              <div className="relative">
                ...
                >
                  <img src={user.avatar} alt="Profile" className="h-11 w-11 rounded-full ring-4 ring-purple-100" />
                ...
                {showDropdown && (
                  <div className="absolute right-0 mt-3 w-64 bg-white rounded-2xl shadow-2xl border border-gray-100 py-3 z-50 animate-in fade-in slide-in-from-top-2">
                    ...
                    <button className="flex items-center gap-3 px-5 py-3 hover:bg-red-50 text-red-600 w-full text-left transition">
                      <LogOut className="h-5 w-5" />
