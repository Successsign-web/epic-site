...
const VendorSignup = () => {
  ...
  const handleSendOtp = () => {
    ...
    toast.info(`OTP sent to ${formData.phone} → For testing purposes, the OTP is: 1234`);
  };
  ...
  const registerVendor = async () => {
    ...
    try {
      ...
      if (status === "active") {
        ...
        toast.info("Registration successful! Admin will review it soon.");
              ...
              <div className="flex justify-between items-center relative">
                ...
                {!showOtpScreen && currentStep < 4 ? (
                  ...
                  <button onClick={handleSendOtp}
                    className="px-8 py-4 bg-gradient-to-r from-green-600 to-emerald-700 text-white rounded-xl font-bold text-lg hover:from-green-700 hover:to-emerald-800 transition-all shadow-xl flex items-center gap-3">
                    <ShieldCheck className="w-7 h-7" /> Send OTP & Register
                  </button>
                )}
