      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="max-w-4xl mx-auto text-gray-700 leading-relaxed space-y-8">
          ...
          <div className="text-center mt-6">
            <a href="mailto:careers@epicweddingportal.com" className="btngradiant text-white font-semibold px-8 py-3 rounded-full shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300">
              Send Your Resume
            </a>
          </div>
        </div>
